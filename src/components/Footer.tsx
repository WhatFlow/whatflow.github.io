    ...
    <footer className="bg-white">
      <div className="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
        <div className="flex justify-center space-x-6 md:order-2">
          <Link href="https://twitter.com" className="text-teal hover:text-green">
          ...
          <Link href="https://instagram.com" className="text-teal hover:text-green">
          ...
          <Link href="https://facebook.com" className="text-teal hover:text-green">
          ...
          <Link href="https://linkedin.com/company/whatflow" className="text-teal hover:text-green">
