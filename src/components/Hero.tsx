      ...
      <div className="mx-auto max-w-7xl px-6 pt-10 pb-24 sm:pb-32 lg:flex lg:py-40 lg:px-8">
        <div className="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
          ...
          <h1 className="mt-10 text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
            Automate Your <span className="text-teal">WhatsApp</span> Confirmations
          </h1>
          <p className="mt-6 text-lg leading-8 text-gray-600">
            WhatFlow helps businesses streamline customer communication by automating WhatsApp messages, appointment confirmations, and follow-ups - saving time and improving customer engagement.
          </p>
              ...
              <div className="flex h-full items-center justify-center">
                <div className="w-full bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
                  <div className="p-4 bg-teal flex items-center">
                    ...
                    <div className="ml-4 text-white text-lg font-semibold">WhatsApp Confirmation</div>
                  </div>
                  <div className="p-4 bg-beige">
                    <div className="flex flex-col space-y-4">
                      <div className="flex">
                        <div className="bg-white rounded-lg p-3 max-w-[70%]">
                          <p className="text-sm">Hello! Your appointment is scheduled for tomorrow at 2:00 PM. Would you like to confirm?</p>
                          <p className="text-xs text-gray-500 mt-1">10:30 AM</p>
                        </div>
                      </div>
                      <div className="flex justify-end">
                        <div className="bg-green-light rounded-lg p-3 max-w-[70%]">
                          <p className="text-sm">Yes, I confirm!</p>
                          <p className="text-xs text-gray-500 mt-1">10:32 AM</p>
                        </div>
                      </div>
                      <div className="flex">
                        <div className="bg-white rounded-lg p-3 max-w-[70%]">
                          <p className="text-sm">Great! Your appointment has been confirmed. We'll see you tomorrow at 2:00 PM.</p>
                          <p className="text-xs text-gray-500 mt-1">10:32 AM</p>
                        </div>
                      </div>
                    </div>
