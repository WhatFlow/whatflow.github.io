        ...
        <div className="mx-auto mt-16 flex max-w-2xl sm:mt-24 lg:ml-10 lg:mr-0 lg:mt-0 lg:max-w-none lg:flex-none xl:ml-32">
          <div className="relative -z-10 w-[57rem] h-[31rem] -mr-[45rem] overflow-hidden rounded-xl border border-gray-200 bg-white p-6 shadow-lg sm:-mr-[38rem] sm:rounded-2xl lg:-mr-0 lg:rounded-3xl lg:p-10">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 h-full items-center">
              <div className="w-full bg-white rounded-xl shadow-md overflow-hidden border border-gray-100 h-[320px]">
                <div className="p-4 bg-teal flex items-center">
                  ...
                  <div className="ml-4 text-white text-lg font-semibold">Abandoned Checkout</div>
                </div>
                <div className="p-4 bg-white">
                  <div className="flex flex-col space-y-4">
                    <div className="flex">
                      <div className="bg-white rounded-lg p-3 max-w-[90%] shadow-sm">
                        <p className="text-sm">Hi Sarah! We noticed you left some items in your cart. Your Premium Plan is still waiting for you!</p>
                        <p className="text-xs text-gray-500 mt-1">2:45 PM</p>
                      </div>
                    </div>
                    <div className="flex justify-end">
                      <div className="bg-green-light rounded-lg p-3 max-w-[90%] shadow-sm">
                        <p className="text-sm">Oh, I got distracted. Do you offer any discounts?</p>
                        <p className="text-xs text-gray-500 mt-1">3:12 PM</p>
                      </div>
                    </div>
                    <div className="flex">
                      <div className="bg-white rounded-lg p-3 max-w-[90%] shadow-sm">
                        <p className="text-sm">Good news! We can offer you 10% off if you complete your purchase today. Here's your checkout link: whatflow.com/checkout/sd63f2</p>
                        <p className="text-xs text-gray-500 mt-1">3:14 PM</p>
                      </div>
                    </div>
                    <div className="flex justify-end">
                      <div className="bg-green-light rounded-lg p-3 max-w-[90%] shadow-sm">
                        <p className="text-sm">Perfect! I'll complete my order now. Thanks!</p>
                        <p className="text-xs text-gray-500 mt-1">3:15 PM</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="w-full bg-white rounded-xl shadow-md overflow-hidden border border-gray-100 hidden sm:block h-[320px]">
                <div className="p-4 bg-teal flex items-center">
                  <svg className="h-8 w-8 text-white" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413Z" />
                  </svg>
                  <div className="ml-4 text-white text-lg font-semibold">Order Fulfillment</div>
                </div>
                <div className="p-4 bg-white">
                  <div className="flex flex-col space-y-4">
                    <div className="flex">
                      <div className="bg-white rounded-lg p-3 max-w-[90%] shadow-sm">
                        <p className="text-sm">Great news, Michael! Your order #1098 has been shipped and is on its way to you. Track: whatflow.com/track/1098</p>
                        <p className="text-xs text-gray-500 mt-1">11:20 AM</p>
                      </div>
                    </div>
                    <div className="flex justify-end">
                      <div className="bg-green-light rounded-lg p-3 max-w-[90%] shadow-sm">
                        <p className="text-sm">Thank you! I've been looking forward to receiving my order.</p>
                        <p className="text-xs text-gray-500 mt-1">11:45 AM</p>
                      </div>
                    </div>
                    <div className="flex">
                      <div className="bg-white rounded-lg p-3 max-w-[90%] shadow-sm">
                        <p className="text-sm">You're welcome! We'll send you another update when your package is delivered. Need anything else?</p>
                        <p className="text-xs text-gray-500 mt-1">11:47 AM</p>
                      </div>
                    </div>
                  </div>
                </div>
