...
//         <svg viewBox="0 0 1155 678" xmlns="http://www.w3.org/2000/svg" width="500" height="400" className="fill-teal-100/50 opacity-30">
...
//             comprehensive suite of automations that engage customers throughout
//             their shopping experience, maximizing revenue and satisfaction.
//           </p>
//         </div>

//         {/* Feature Grid */}
//         <div className="mx-auto mt-16 max-w-2xl lg:mt-20 lg:max-w-none">
//           <dl className="grid grid-cols-1 gap-x-12 gap-y-14 lg:grid-cols-2">
//             {features.map((feature, i) => (
//               <div
//                 key={i}
//                 className="relative rounded-2xl bg-[#ffff] p-6 shadow-lg hover:shadow-2xl transition-shadow duration-300 border border-gray-100 hover:border-green-200 last:lg:col-span-2 last:lg:mx-auto last:lg:max-w-xl"
//               >
//                 <div className="absolute -top-5 left-6 flex h-12 w-12 items-center justify-center rounded-xl bg-green-100 shadow-md ring-1 ring-green-200">
//                   {feature.icon}
//                 </div>
//                 <dt className="mt-8 text-lg font-semibold text-gray-900">
//                   {feature.name}
//                 </dt>
