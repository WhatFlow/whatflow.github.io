          ...
          <div className="p-6 sm:p-8 md:p-10">
            ...
            <div className="mb-10">
              <p className="text-lg text-ink">
                At <span className="font-semibold text-primary-dark">WhatFlow</span>, 
            ...
            <div className="space-y-10">
              ...
              <section id="information-collected" className="scroll-mt-24">
                ...
                <ul className="list-disc pl-6 space-y-4 text-text-muted">
                  <li>
                    <span className="font-semibold text-ink">WhatsApp Account Access:</span> When you connect your WhatsApp account, 
                  ...
                  <li>
                    <span className="font-semibold text-ink">Order & Customer Data:</span> We collect information related to Shopify 
                  ...
                  <li>
                    <span className="font-semibold text-ink">Usage Data:</span> We collect basic app usage data to enhance performance 
              ...
              <section id="information-usage" className="scroll-mt-24">
                ...
                <ul className="list-disc pl-6 space-y-4 text-text-muted">
                  <li>
                    <span className="font-semibold text-ink">Comprehensive Message Automation:</span> WhatFlow uses your WhatsApp account 
                  ...
                  <li>
                    <span className="font-semibold text-ink">Data Security:</span> All communications between your WhatsApp account, 
              ...
              <section id="gdpr" className="scroll-mt-24">
                ...
                <ul className="list-disc pl-6 space-y-2 text-text-muted">
                  <li><span className="font-semibold text-ink">Right to Access:</span> You may request access to the personal data we hold about you at any time.</li>
                  <li><span className="font-semibold text-ink">Right to Rectification:</span> You have the right to request corrections to any inaccurate or incomplete personal data.</li>
                  <li><span className="font-semibold text-ink">Right to Erasure:</span> You may request the deletion of your personal data under certain conditions.</li>
                  <li><span className="font-semibold text-ink">Right to Restrict Processing:</span> You may request a limitation on how we process your personal data.</li>
                  <li><span className="font-semibold text-ink">Right to Data Portability:</span> You may request a copy of your personal data in a structured, machine-readable format.</li>
                </ul>
