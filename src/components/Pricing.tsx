  ...
  const plans = [
    {
      name: "Free",
      description:
        "Perfect for testing our full automation suite with limited message volume.",
      price: "$0",
      limit: "50 messages",
    ...
    },
    {
      name: "Starter",
      description:
        "Ideal for small businesses beginning to leverage WhatsApp automation.",
      price: "$4.99",
    ...
    },
    {
      name: "Growth",
      description:
        "Perfect for growing businesses with increasing automation needs.",
      price: "$9.99",
      limit: "3,000 messages",
      nextTier:
        "Up to 3,000 messages, then auto-upgrades to Professional plan.",
      featured: true,
    ...
    },
    {
      name: "Professional",
      description:
        "Designed for established businesses with substantial customer communication.",
      price: "$14.99",
    ...
    },
    {
      name: "Enterprise",
      description:
        "For high-volume businesses that need extensive automation capabilities.",
      price: "$24.99",
    ...
    },
    {
      name: "Ultimate",
      description:
        "Unlimited messaging for large businesses with maximum automation needs.",
      price: "$49.99",
      limit: "No limits!",
      nextTier: "",
      featured: false,
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Choose the perfect plan for your WhatsApp automation needs. All
            plans include our complete suite of automation features.
          </p>
        </div>

        <div className="mt-10 bg-white rounded-3xl p-8 ring-1 ring-gray-200 shadow-sm">
          <p className="text-center text-gray-600 mb-4">
            All plans include the same powerful features with Shopify
            subscription management. The only difference is the number of
              ...
              <ul className="mt-8 space-y-3 text-sm leading-6 text-gray-600">
                {commonFeatures.map((feature) => (
                  <li key={feature.name} className="flex gap-x-3">
                    <svg
                      className="h-6 w-5 flex-none text-green"
                      viewBox="0 0 20 20"
                      fill="currentColor"
                      aria-hidden="true"
                    >
        ...
        <div className="mt-12 text-center">
          ...
          <p className="mt-2 text-sm text-gray-500">
            For businesses that need more power and flexibility
          </p>
        </div>
